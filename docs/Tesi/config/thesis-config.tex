...
% Definizione di un ulteriore livello di sezione
\titleclass{\subsubsubsubsection}{straight}[\subsubsubsubsection]
\newcounter{subsubsubsubsection}[subsubsubsubsection]
\renewcommand\thesubsubsubsubsection{\thesubsubsubsubsection.\arabic{subsubsubsubsection}}
\titleformat{\subsubsubsubsection}
  {\normalfont\normalsize\bfseries}{\thesubsubsubsubsection}{1em}{}
\titlespacing*{\subsubsubsubsection}
  {0pt}{1.25ex plus 1ex minus .2ex}{0.75ex plus .2ex}

% Aggiungere le nuove sezioni nell'indice
\setcounter{secnumdepth}{4}  % Abilitare la numerazione fino al quarto livello
\setcounter{tocdepth}{4}      % Mostrare fino al quarto livello nell'indice