...
\usepackage[final]{listings}                   % codici
...
\usepackage[
    ...
    backref,
    sorting=none,
    maxbibnames=3,  % Numero massimo di autori nella bibliografia prima di usare "et al."
    maxcitenames=2  % Numero massimo di autori nelle citazioni prima di usare "et al."
]{biblatex}
